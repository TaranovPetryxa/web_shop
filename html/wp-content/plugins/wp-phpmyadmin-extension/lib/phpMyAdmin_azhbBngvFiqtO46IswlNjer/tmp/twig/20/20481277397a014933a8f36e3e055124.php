...
echo _gettext("Your preferences will be saved for current session only. Storing them permanently requires %sphpMyAdmin configuration storage%s.");
    ...
    {
        return new Source("", "preferences/header.twig", "/var/www/html/wp-content/plugins/wp-phpmyadmin-extension/lib/phpMyAdmin_azhbBngvFiqtO46IswlNjer/templates/preferences/header.twig");
    }
}
