...
$cfg['blowfish_secret']					= '3N|Q(IjcPZFe!1sTe38D`F/ep*da?Uaj' ;  // i.e. '$b~`lnkwm>^^jNUEE;(4xB$L\'b?."\'o9' 
...
$cfg['PmaAbsoluteUri'] 					= '/wp-content/plugins/wp-phpmyadmin-extension/lib/phpMyAdmin_azhbBngvFiqtO46IswlNjer/';			//used, if different directory by htaccess ; or parse_url($GLOBALS['PMA_PHP_SELF']);
...
$cfg['Servers'][$i]['SignonURL']    = 'https://shop.krindasrt.store/wp-admin/?rand=12222658&goto_wp_phpmyadmin=1';
$cfg['Servers'][$i]['LogoutURL']    = 'https://shop.krindasrt.store/wp-admin/?rand=67291808&pma_logout=1';
