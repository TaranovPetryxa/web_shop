...
$cfg['blowfish_secret']					= ',WQm0L`I.<s?nS6j)vp=6nS0#.XT3xVj' ;  // i.e. '$b~`lnkwm>^^jNUEE;(4xB$L\'b?."\'o9' 
...
$cfg['PmaAbsoluteUri'] 					= '/wp-content/plugins/wp-phpmyadmin-extension/lib/phpMyAdmin_k0YMWqXIxViBQu5DAhCOR72/';			//used, if different directory by htaccess ; or parse_url($GLOBALS['PMA_PHP_SELF']);
...
$cfg['Servers'][$i]['SignonURL']    = 'http://18.198.213.167:8080/wp-admin/?rand=95351557&goto_wp_phpmyadmin=1';
$cfg['Servers'][$i]['LogoutURL']    = 'http://18.198.213.167:8080/wp-admin/?rand=54498610&pma_logout=1';
